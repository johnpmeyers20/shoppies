...
const Button = (props) => {
  // const movieView = props.movieView;

  return (
    <div class="svg-container" id="boogerRadio">
      <button class='grid-view green' onClick={props.handleClick} >
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-image" viewBox="0 0 16 16">
        ...
        <button class="list-view" onClick={props.handleClick}>
